...
Age_data <- Age_data %>% mutate(Categ1_Aged1 = Aged1 - lag(Aged1, 2))
...
DF2 <-data.frame(Categ1_Aged1 = as.numeric(Age_data$Categ1_Aged1)/2,    
                 Categ2_Aged1to4  =  as.numeric(Age_data$Categ2_Aged1to4)/2,  
